        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    ...
                    <section>
                        ...
                        <form method="POST" action="{{ url('teachers_reg_form') }}" enctype="multipart/form-data">
                            @csrf
                            
                            <!-- User Id -->
                            <div>
                                <x-input-label for="user_id" :value="__('User Id')" />
                                <x-text-input id="user_id" class="block mt-1 w-full" type="text" name="user_id" :value="old('user_id')"  autofocus autocomplete="user_id" />
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <x-select-input id="marital_status" class="block mt-1 w-full" type="text" name="marital_status" :value="old('marital_status')" required autofocus autocomplete="marital_status" />
                            <option></option>
                           ...
                           <div>
                            ...
                            <x-text-input id="dofa" class="block mt-1 w-full" type="text" name="dofa" :value="old('dofa')" required autofocus autocomplete="dofa" />
                        ...
                        <div>
                           ...
                           <div>
                            ...
                            <div>
                                ...
                                <x-text-input id="promotion_yr" class="block mt-1 w-full" type="text" name="promotion_yr" :value="old('promotion_yr')" autofocus autocomplete="promotion_yr" />
                           ...
                           <div>
                            ...
                            <x-text-input id="contact_no" class="block mt-1 w-full" type="text" name="contact_no" :value="old('contact_no')" required autofocus autocomplete="contact_no" />
                            ...
                            <div>
                                ...
                                <x-text-input id="bank_branch" class="block mt-1 w-full" type="text" name="bank_branch" :value="old('bank_branch')" autofocus autocomplete="bank_branch" />
                            ...
                            <div>
                                ...
                                <x-text-input id="acct_name" class="block mt-1 w-full" type="text" name="acct_name" :value="old('acct_name')" autofocus autocomplete="acct_name" />
                            ...
                            <div>
                                ...
                                <x-text-input id="acct_no" class="block mt-1 w-full" type="text" name="acct_no" :value="old('acct_no')" autofocus autocomplete="acct_no" />
                            ...
                            <div>
                                ...
                                <x-text-input id="allowance" class="block mt-1 w-full" type="text" name="allowance" :value="old('allowance')" autofocus autocomplete="allowance" />
                            ...
                            <div>
                                ...
                                <x-text-input id="hometown" class="block mt-1 w-full" type="text" name="hometown" :value="old('hometown')" autofocus autocomplete="hometown" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nok" class="block mt-1 w-full" type="text" name="nok" :value="old('nok')" autofocus autocomplete="nok" />
                            ...
                            <div>
                                ...
                                <x-text-input id="relationship" class="block mt-1 w-full" type="text" name="relationship" :value="old('relationship')" autofocus autocomplete="relationship" />
