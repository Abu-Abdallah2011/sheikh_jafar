               ...
               <div class="text-center font-bold"> Sessions </div>
                <table class="border-collapse w-full">
                    ...
                    <tr>
                        ...
                        <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">DAYS OF SCHOOL</th>
                    ...
                    <tr  class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap mb-10 lg:mb-0">
                        ...
                        <td class="w-full lg:w-auto p-3 text-gray-800 border border-b block lg:table-cell relative lg:static">{{ $session->days }}</td>
